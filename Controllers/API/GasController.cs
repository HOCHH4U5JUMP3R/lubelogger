        ...
        public IActionResult AllGasRecords(MethodParameter parameters)
        {
            ...
            var result = vehicleRecords
                .Select(x => new GasRecordExportModel
                {
                    ...
                    DeltaOdometer = x.DeltaMileage.ToString(),
                    ...
                    UnitCost = x.CostPerGallon.ToString(),
                    PaymentType = x.ExtraFields.FirstOrDefault(y => y.Name == "Payment Type")?.Value ?? string.Empty,
